...
const app = express();
const port = 3000;
const fitted = require("./fittedroutes/fitted");
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    function getWorkoutPost(workoutObj, callback, count = 0) {
      ...
      jQuery.ajax({
        url: "https://elihedrick.github.io/workoutcreator/index.php/wp-json/wp/v2/dropdown",
        data: data,
        type: "POST",
    ...
    * @result success message => refresh method
    ...
    function saveWorkout(saveData) {
      jQuery.ajax({
        url: "https://elihedrick.github.io/workoutcreator/index.php/wp-json/wp/v2/save_workout",
        data: {
          saveData: saveData,
          user_id: userId
        },
    ...
    function getAllClients() {
      jQuery.ajax({
        url: "https://elihedrick.github.io/workoutcreator/index.php/wp-json/wp/v2/get_all_clients",
        type: "GET",
        data: {
          user_id: userId
        },
    ...
    function getAllClientWorkouts(clientName) {
      jQuery.ajax({
        url: "https://elihedrick.github.io/workoutcreator/index.php/wp-json/wp/v2/get_all_client_workouts",
        type: "GET",
    ...
    function getWorkout(elementData) {
      jQuery.ajax({
        url: "https://elihedrick.github.io/workoutcreator/index.php/wp-json/wp/v2/get_workout",
        type: "GET",
        data: {
          user_id: userId,
    ...
    function deleteWorkoutAjax() {
      jQuery.ajax({
        url: "https://elihedrick.github.io/workoutcreator/index.php/wp-json/wp/v2/delete_workout",
        type: "POST",
        data: {
          user_id: userId,
